...
table1 = [['Option', 'Ticket Type', 'Cost for one day', 'Cost for two days'], ['1', 'One Adult', '$20.00', '$30.00'],
                  ['2', 'One Child (An Adult may bring up to two children', '$12.00', '$18.00'],
                  ['3', 'One Senior', '$16.00', '$24.00'],
                  ['4', 'Family Ticket ( Upto two adults or seniors and three children)', '$60.00', '$90.00'],
                  ['5', 'Groups of six people or more, price per person', '$15.00', '$22.50']]
print(tabulate(table1, headers='firstrow', tablefmt='fancy_grid'))

# table for extra attractions:
table2 = [['Option', 'Extra attraction', 'Cost per person'], ['1', 'Lion feeding', '$2.50'],
                  ['2', 'Penguin Feeding', '$2.00'], ['3', 'Evening barbecue (two-day tickets only)', '$5.00']]
...
while True:
       ...
       while adult+child+senior>i:
              ...
              if (adult + senior > 2) and child >= 3:
                     adultdown = math.floor(adult / 2)*2
                     childdown = math.floor(child / 3)*3
                     seniordown = math.floor(senior/2)*2
                     ...
                     elif (adultdown >= 2) and childdown >= 3 and people%5==0 and childdown%3==0:
                            if day_input==1:
                                   while day1grp*people > num * 60 and num < 100:
                                          num += 1
                            if day_input==2:
                                   while day2grp*people> num * 60 and num <100:
                                          num+=1
                            ...
                            if offer=="Y":
                                   if day_input==1:
                                          for f in range(num-1):
                                                 basket.append(['Family Ticket',  'One Day', day1fam])
                                          print("\nFamily Ticket added Successfully!!")
                                          adult=adult-adultdown
                                          child=child-childdown
                                          continue;
              ...
              if day_input == 1:
                     ...
                     #Family Ticket Day 1
                            ...
                            if adult1 != adult and adult1>2:
                                   print("Number of adults are not equal")
                                   continue
                            if senior1 != senior and senior1>2:
